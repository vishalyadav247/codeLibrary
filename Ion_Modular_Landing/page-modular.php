		...
		while (have_rows('modules')) :
			...
			?>
				...
				<?php if ($video) { ?>
							...
							<div class="row">
								...
								?>
									<div class="col-12 col-md-6 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.25s">
										<img src="<?php echo $logo; ?>" class="mb-2 mt-1" style="max-width: 100%;">
								...
								<?php } else { ?>
									...
									<div class="button-group d-flex justify-content-center">
										<a href="<?php echo $button1['url'] ?>" class="color-btn rmHover"><?php echo $button1['title'] ?></a>
										<a href="<?php echo $button2['url'] ?>" class="simple-btn rmHover" style="border-color: var(--white);color:var(--white);"><?php echo $button2['title'] ?></a>
									</div>
								<?php }
								?>
							</div>
						...
						<section id="image-content-wrapper" class="sectionPy <?php echo $background ?> <?php echo $reverse_class ?>">
							<div class="container image-content">
								<div class="wow fadeInUp content-wrapper" data-wow-duration="1s" data-wow-delay="0.25s">
									<p class="new-badge dyn-white"><?php echo $badge; ?></p>
									<img src="<?php echo $logo; ?>" class="mb-2 mt-1" style="max-width: 100%;">
									...
									<div class="button-group d-flex">
										<a href="<?php echo $button1['url'] ?>" class="color-btn rmHover"><?php echo $button1['title'] ?></a>
										<a href="<?php echo $button2['url'] ?>" class="simple-btn rmHover"><?php echo $button2['title'] ?></a>
									</div>
								</div>
					...
					<?php elseif ('footer' == get_row_layout()) :
					...
					<?php elseif ('footer_top' == get_row_layout()) :
					?>
